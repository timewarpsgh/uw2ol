hash_items = {
	...
	###### Weapon ######
		...
		42:  {
            ...
            'price': 380000,
            'image': [8, 6],
            'description': "A treasured sword made in the 15th century by a famous Japanese sword smith, Muramasa."
		},
		43:  {
            'name': "Siva's Sword(*)",
            'price': 280000,
            'image': [8, 6],
            'description': "A legendary sword that's believed to confine the power of Siva, the Hindu god of destruction. A powerful lashing weapon."
		},
