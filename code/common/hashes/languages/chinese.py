...
"exp for": "经验值， 卖出",
    ...
    # villages
    "Named for its cry, this is a flightless, nocturnal bird with a small head and a long, slender bill that has nostrils near the tip. It uses its highly developed sense of smell to find its food." : '这是一种不会飞的夜行鸟，因其叫声而得名，头部小，嘴细长，鼻尖附近有鼻孔。它利用高度发达的嗅觉来寻找食物。',
    "A tree-dwelling marsupial mammal that only eats the leaves of the eucalyptus tree. Koala young spend their first 6 months in their mother's pouch, feeding on predigested eucalyptus leaves." : '只吃桉树叶子的树栖有袋哺乳动物。考拉幼仔头6个月在母亲的育儿袋里度过，以母亲预消化过的桉树叶为食。',
    "A legend says that there is a humongous red monolith in the center of this continent." : '传说在这块大陆的中心有一块巨大的红色巨石。',
    "A 30 inch long nocturnal animal that feeds on small animals and carrion. It hides in the cracks of rocks and trees." : '一种30英寸长的夜间活动的动物，以小动物和腐肉为食。它藏在岩石和树木的裂缝里。',
    "A lizard with a large umbrella-like frill. It rises up and opens the frill to intimidate enemies and runs away only on its rear legs." : '有大伞状褶边的蜥蜴。它站起来，打开褶边恐吓敌人，只靠后腿逃跑。',
    "Its long fat tail and powerful hind legs help this animal hip-hop along. The newly born infants, still small and pinkish, crawl into a pouch on the mother's belly and remain there during infancy." : '又长又肥的尾巴和有力的后腿帮助这种动物跳跃前进。刚出生的婴儿，很小，呈粉红色，基本上整个婴儿期都待在母亲的育儿袋里。',
    "A manuscript of Mayan legends, describing their philosophy, cosmology, and history." : '印有玛雅传说的手稿，描述着他们的哲学、宇宙观和历史。',
    "A mask encrusted with small pieces of jade. Its eye holes give it a somewhat ominous appearance." : '镶有小块玉石的面具。它的眼孔让它看起来有点可怕。',
    "A holy place for the Muisca, who throw gold and emeralds into the lake when their new king ascends the throne." : '穆伊斯卡人的圣地，当他们的新国王登上王位时，穆伊斯卡人将黄金和祖母绿扔进湖中。',
    "A round stone monument symbolizing the sun and the seasons. It represents the Aztec people's concept of the universe." : '象征太阳和季节的圆形石碑。它代表了阿兹特克人的宇宙观。',
    "An elaborately sculptured crystal skull used for generations in rituals by tribal leaders." : '一颗精雕细琢的水晶头骨，世代用于部落首领的仪式中。',
    "A large lizard with black and yellow bead-like scales. Its secret weapon is its ability to produce poison in its mouth." : '有黑色和黄色珠状鳞片的大型蜥蜴。它的秘密武器是能在嘴里产生毒素。',
    "A stone bust excavated from Tenochtitlan." : '从特诺赫蒂兰出土的石像。',
    "A mural of warriors and hunting gods." : '展现着武士和狩猎神的壁画。',
    "A perfectly spherical stone measuring about 6.5 feet in diameter. Its use is unknown." : '一种完美的球形石头，直径约6.5英尺。它的用途不详。',
    "Monkey with a colorful face resembling that of a human. It has a beard, purple bottom, and a short tail." : '五颜六色的象人的猴子。它有胡子，紫色的屁股和短尾巴。',
    "A large bear-like black and white animal found at high altitudes in mountainous regions. It's friendly and feeds on bamboo." : '一种类似熊的黑白相间的大型动物，见于山区的高海拔地区。它很友好，以竹子为食。',
    "1500 miles long and averaging 25 feet high, this truly is a great wall. It was constructed over many generations by Chinese rulers as a defense against raids by nomads in the north." : '1500英里长，平均25英尺高，这真是一座长城。它是中国统治者为抵御北方游牧民族的袭击，历经数代，而建造的。',
    "Empress Zetian Wuhou's tomb. A hill with a circumference of 25 miles was turned into this huge tomb where all her treasures are buried." : '女皇帝武则天的墓。一座周长25英里的小山被改建变成了这个巨大的坟墓，她所有的宝藏都埋在这里。',
    "A small mammal with an arsenal of long prickly spines on its back. It rolls itself into a ball when threatened." : '一种小型哺乳动物，背部有许多长长的刺。当受到威胁时，它会卷成一个球。',
    "Fabled demons that kidnap and devour bad children. The legend is told in a traditional festival where men disguise themselves as demons to scare the town's children." : '传说中绑架并吃掉坏小孩儿的的恶魔。这个传说是在一个传统节日里讲的，在这个节日里，人们把自己伪装成恶魔来吓唬镇上的孩子。',
    "Ruins of farming villages dating from around 300 B.C. The villages had rice fields orderly divided by strong ridges and storehouses with elevated floors." : '大约公元前300年的农业村庄遗址。这些村庄有整齐的稻田，由坚固的垄和高地板的仓库隔开。',
    "A strange insect which transforms itself into a fungus during the summer. It is highly valued in China as a tonic and an elixir." : '一种奇怪的昆虫，在夏天会变成真菌。在中国，它作一种药材很有价值。',
    "The world's largest poisonous snake. When disturbed, it extends its ribs behind its head to form a flaring hood." : '世界上最大的毒蛇。当受到侵扰时，它会将肋骨延伸到头部后面，形成一个向外扩张的架势。',
    "Ruins of a city dating from the time of the Indus civilization. Built around a dome-shaped Buddhist shrine on a hilltop, this city probably was a commercial center during the Bronze Age." : '印度文明时期的城市废墟。这座城市围绕着山顶上一座圆顶形的佛教圣地而建，在青铜时代可能是一个商业中心。',
    "The people who live here have built their homes and fields on the island that floats on the surface of this lake." : '住在这里的人们在漂浮在湖面上的小岛上建起了自己的家园和田地。',
    "Lizard with the amazing ability to change its color to match its surroundings. It's quite adept at capturing insects with its long and sticky tongue." : '蜥蜴有着惊人的改变颜色以适应周围环境的能力。它很擅长用又长又粘的舌头捕捉昆虫。',
    "A bird the size of a turkey, with a large hooked bill. Its wings are very small, making it incapable of flight." : '火鸡大小的鸟，有一个大钩状的喙。它的翅膀很小，不能飞行。',
    "Strange black liquid that springs out from underground in desert areas. It has a bad smell and burns easily." : '沙漠地区从地下冒出的奇怪的黑色液体。它有一股难闻的气味，很容易燃烧。',
    "Tall water plant that was used to make a form of paper in ancient Egypt." : '一种高大的水生植物，在古埃及用于造纸。',
    "Black basalt slab bearing the same inscription in three languages- ancient Egyptian hieroglyphics, a simpler ancient Egyptian writing system, and Greek." : '刻有三种语言的黑色玄武岩板：古埃及象形文字，一种更简单的古埃及书写系统，和希腊语。',
    "Fierce amphibious predator armored with hard leather skin, the crocodile sometimes reaches a length of 20 feet. With its powerful jaws, it can rip into livestock animals and even humans with one bite." : '凶猛的两栖捕食者，披着坚硬的皮甲，有时长达20英尺。凭借其强大的下颚，它可以一口咬死牲畜，甚至人类。',
